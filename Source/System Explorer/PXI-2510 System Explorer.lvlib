	...
	<Item Name="System Explorer" Type="Folder">
		<Item Name="Dynamically Called" Type="Folder">
			<Item Name="Extra Pages" Type="Folder">
				<Item Name="PXI-2510 Channel Page.vi" Type="VI" URL="../Extra Pages/PXI-2510 Channel Page.vi"/>
				<Item Name="PXI-2510 Fault Bus Page.vi" Type="VI" URL="../Extra Pages/PXI-2510 Fault Bus Page.vi"/>
			</Item>
		...
		<Item Name="Types" Type="Folder">
			<Item Name="Channel Fault Selector.ctl" Type="VI" URL="../Types/Channel Fault Selector.ctl"/>
			<Item Name="Fault Bus Input Selector.ctl" Type="VI" URL="../Types/Fault Bus Input Selector.ctl"/>
		</Item>
	</Item>
</Library>
